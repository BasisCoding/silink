...
<body>
  ...
  <section>
    <div class="container-fluid">
      <div class="row">
        <div class="col-xl-7"><img class="bg-img-cover bg-center" src="<?= site_url('assets/images/login/2.jpg') ?>" alt="loginpage"></div>
        <div class="col-xl-5 p-0">
          <div class="login-card">
            <form class="theme-form login-form" id="form-login" method="POST">
              <h4>Login</h4>
              ...
              <p>Don't have account?<a class="ms-2" id="sign-up">Create Account</a></p>
            </form>
          </div>
        </div>
      </div>
